      ...
      <template slot-scope="scope">
        ...
        <el-table-column label="状态" >
            <template slot-scope="scope">
                <el-button
                    size="mini"
                    :type="scope.row.status==='T'?'danger':'success'"
                    @click="handelStatus( scope.row)"
                >{{scope.row.status==='T'?'禁用':'启用'}}</el-button>
            </template>
        </el-table-column>
        <el-table-column label="操作">
            <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="handleEdit( scope.row)">编辑</el-button>
                <el-button size="mini" type="success" @click="addChild( scope.row)">添加子分类</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            iconShow(index, record) {
                return index === 1 && record.child && record.child.length > 0;
            }
